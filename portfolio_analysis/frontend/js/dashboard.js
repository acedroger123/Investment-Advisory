...
function updateHoldingsTable(holdings) {
    ...
    if (!holdings || holdings.length === 0) {
        tbody.innerHTML = `
            <tr class="empty-row">
                <td colspan="6">No holdings yet. Add transactions to get started.</td>
            </tr>
        `;
        return;
    }
